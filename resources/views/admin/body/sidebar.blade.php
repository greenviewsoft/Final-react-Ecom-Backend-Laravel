<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<h4 class="logo-text">Sultan Shop</h4>
				</div>
...
<li>
	<a href="{{ url('/dashboard') }}">
		...
		<div class="menu-title">Dashboard</div>
				...
				<li class="menu-label">Mange Site</li>
			...
			<div class="menu-title">Product Review</div>
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						...
						<div class="menu-title">Mange Order</div>
					</a>
					<ul>
						<li> <a href="{{ route('pending.order') }}"><i class="bx bx-right-arrow-alt"></i>Pending Order</a>
						</li>
						<li> <a href="form-input-group.html"><i class="bx bx-right-arrow-alt"></i>Prossesing Order</a>
						</li>
						<li> <a href="form-layouts.html"><i class="bx bx-right-arrow-alt"></i>Complete Order</a>
						</li>
