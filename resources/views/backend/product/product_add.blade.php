           ...
           <div class="border border-3 p-4 rounded">
			...
			<div class="mb-3">
				<label for="inputProductTitle" class="form-label">Product Title</label>
								<input type="text" name="title" class="form-control" id="inputProductTitle" placeholder="Enter product Code">
			  </div>
...
<div class="mb-3">
 ...
 <div class="mb-3">
	...
	<textarea id="mytextarea" name="long_description">Hello, Customer!</textarea>
  </div>
</div>
		   </div>
		   <div class="col-lg-4">
